...
export declare function _firebaseAppFactory(options: FirebaseOptions, name?: string, appConfig?: FirebaseAppConfig): FirebaseApp;
export declare class AngularFireModule {
    static initializeApp(options: FirebaseOptions, appNameOrConfig?: string | FirebaseAppConfig): {
        ...
        providers: ({
            ...
            provide: InjectionToken<string | undefined>;
            useValue: string | undefined;
        } | {
            provide: InjectionToken<FirebaseAppConfig | undefined>;
            useValue: FirebaseAppConfig | undefined;
        })[];
    };
}
