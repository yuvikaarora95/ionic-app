...
var AngularFireAuth = (function () {
    function AngularFireAuth(options, config, name, platformId, zone) {
        var _this = this;
        this.zone = zone;
        ...
        this.idToken = scheduler.keepUnstableUntilFirst(scheduler.runOutsideAngular(new rxjs.Observable(function (subscriber) {
            var unsubscribe = _this.auth.onIdTokenChanged(subscriber);
            return { unsubscribe: unsubscribe };
        }))).pipe(rxjs_operators.switchMap(function (user) {
