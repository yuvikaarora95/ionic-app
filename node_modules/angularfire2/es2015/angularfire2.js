...
export const FirebaseAppNameToken = new InjectionToken('angularfire2.app.name');
export const FirebaseOptionsToken = new InjectionToken('angularfire2.app.options');
export const FirebaseAppConfigToken = new InjectionToken('angularfire2.app.config');
